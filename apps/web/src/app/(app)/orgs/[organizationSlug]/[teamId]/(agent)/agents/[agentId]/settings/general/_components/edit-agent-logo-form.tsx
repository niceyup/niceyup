...
export function EditAgentLogoForm({
  params,
  logo,
  isAdmin,
}: {
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex flex-col gap-3">
                  <h2 className="font-semibold text-xl">Agent Avatar</h2>
                  <div className="flex flex-row items-start justify-between gap-3">
                    <div className="flex flex-col items-start gap-2">
                      <p className="text-muted-foreground text-sm">
                        This is your agent's avatar.
                      </p>
                      <p className="text-muted-foreground text-sm">
                    ...
                    {!isAdmin ? (
                      <div className="relative inline-flex max-w-min">
                        <div className="relative flex size-20 items-center justify-center overflow-hidden rounded-full border border-input border-dashed has-[img]:border-none">
                          {field.value ? (
                            <img
