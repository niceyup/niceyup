...
import type { ModelProviderGoogle } from '@workspace/core/model-providers'
...
type GoogleModelProviderProps = {
  onSuccess: () => void
  onBack: () => void
  initialData?: {
    name: string
    credentials: ModelProviderGoogle['credentials']
  }
}

export function GoogleModelProvider({
  onSuccess,
  onBack,
  initialData,
}: GoogleModelProviderProps) {
  ...
  return (
    <Form {...form}>
      ...
      >
        <ModelProviderCard provider={availableModelProviders.google} />
