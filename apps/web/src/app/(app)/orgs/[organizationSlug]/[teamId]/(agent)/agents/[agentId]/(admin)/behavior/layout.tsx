...
export default async function Layout({
  ...
  const items: SidebarItem[] = [
    {
      label: 'General',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/behavior/general`,
    },
    {
      label: 'System Configuration',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/behavior/system-configuration`,
    },
    {
      label: 'Documentation',
      href: 'https://docs.niceyup.com/agents/behavior',
      target: '_blank',
        ...
        >
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <h2 className="font-semibold text-sm">Behavior</h2>
              <p className="mt-1 text-muted-foreground text-sm">
                Configure the model, prompts, and settings that control how this
                AI agent responds.
              </p>
            </div>
          </div>
