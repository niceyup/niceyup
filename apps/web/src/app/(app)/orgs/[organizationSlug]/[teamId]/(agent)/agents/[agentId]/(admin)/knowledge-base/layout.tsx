...
export default async function Layout({
  ...
  const items: SidebarItem[] = [
    {
      label: 'Overview',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/knowledge-base/overview`,
    },
    {
      label: 'Configure',
    ...
    {
      label: 'Data Sources',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/knowledge-base/sources`,
    },
    {
      label: 'Evaluate',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/knowledge-base/evaluate`,
    },
    {
      label: 'Documentation',
      href: 'https://docs.niceyup.com/agents/knowledge-base',
      target: '_blank',
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              ...
              <p className="mt-1 text-muted-foreground text-sm">
                Manage the knowledge base this AI agent can use to learn and
                respond.
              </p>
            </div>
          </div>
