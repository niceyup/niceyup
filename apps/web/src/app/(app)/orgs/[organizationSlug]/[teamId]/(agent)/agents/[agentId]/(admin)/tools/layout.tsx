...
export default async function Layout({
  ...
  const items: SidebarItem[] = [
    {
      label: 'General',
      href: `/orgs/${organizationSlug}/${teamId}/agents/${agentId}/tools/general`,
    },
    {
      label: 'Marketplace',
      href: 'https://marketplace.niceyup.com/tools',
      target: '_blank',
      icon: <SquareArrowOutUpRightIcon className="ml-auto" />,
    },
    {
      label: 'Documentation',
      href: 'https://docs.niceyup.com/agents/tools',
      target: '_blank',
      icon: <SquareArrowOutUpRightIcon className="ml-auto" />,
    },
  ]
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              ...
              <p className="mt-1 text-muted-foreground text-sm">
                Manage the tools this AI agent can use to perform tasks.
              </p>
            </div>
          </div>
        </div>
